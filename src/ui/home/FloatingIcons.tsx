...
import { SiVsco, SiReact, SiNextdotjs, SiTailwindcss } from 'react-icons/si';
...
const floatingIcons = [
  ...
  { id: 3, icon: <SiVsco />, color: "text-blue-500", size: "w-7 h-7", position: "bottom-[25%] left-[15%]", duration: 18 },
