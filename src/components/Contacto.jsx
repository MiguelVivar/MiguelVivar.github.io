...
function Contacto() {
    ...
    return (
        <div id="contacto" className="section">
            <section className="section container mb-5 border">
                    ...
                    <div className="column">
                        <div className="field">
                            ...
                            <div className="control">
                                ...
                                className="input"/>
                                {errors.nombre && <p className="has-background-danger has-text-white p-2 has-text-centered is-size-5">{errors.nombre}</p>}
                            </div>
                        </div>
                        <div className="field">
                            ...
                            <div className="control">
                                ...
                                onChange={handleInputChange}
                                />
                                {errors.email && <p className="has-background-danger has-text-white p-2 has-text-centered is-size-5">{errors.email}</p>}
                            </div>
                        </div>
                        <div className="field">
                            ...
                            <div className="control">
                                ...
                                />
                                {errors.mensaje && <p className="has-background-danger has-text-white p-2 has-text-centered is-size-5">{errors.mensaje}</p>}
                            </div>
                        </div>
